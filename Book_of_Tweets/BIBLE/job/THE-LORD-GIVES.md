...
CREATE (t:THOUGHT {
    name: "passage.THE LORD GIVES",
    alias: "PASSAGE: Divine Sovereignty",
    parent: "topic.DIVINE SOVEREIGNTY",
    tags: ["sovereignty", "blessing", "job", "lords_name", "trust"],
    source: "Job 1:21'",
    sortedsource: "'Zephaniah 01:21'",
    biblelink: "(https://www.biblegateway.com/passage/?search=Job%201%3A21&version=CSB)",
    level: 2
});
...
MERGE (parent)-[:HAS_THOUGHT {name: "b.edge.DIVINE SOVEREIGNTY->THE LORD GIVES"}]->(child);
```
