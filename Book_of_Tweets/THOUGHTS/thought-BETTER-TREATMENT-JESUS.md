...
CREATE (t:THOUGHT {    name: "thought.BETTER TREATMENT JESUS",
    alias: "Thought: Better Treatment Jesus",
    parent: "topic.THE GODHEAD",
    tags: ['jesus', 'life', 'treatment', 'grace', 'divinity'],
    level: 1});
...
ON CREATE SET r.name = "t.edge.BETTER TREATMENT JESUS"
// 3. Pass 't' forward, find the Parent Topic, and link them
WITH t
MATCH (parent:TOPIC {name: "topic.THE GODHEAD"})
MERGE (parent)-[r2:HAS_THOUGHT]->(t)
ON CREATE SET r2.name = "t.edge.THE GODHEAD->BETTER TREATMENT JESUS"
RETURN t, parent;
```
