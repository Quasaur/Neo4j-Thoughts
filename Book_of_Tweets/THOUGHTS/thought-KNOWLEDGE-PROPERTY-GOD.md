...
CREATE (t:THOUGHT {    name: "thought.KNOWLEDGE PROPERTY GOD",
    alias: "Thought: Knowledge Property God",
    parent: "topic.TRUTH",
    tags: ['knowledge', 'ownership', 'property', 'god', 'truth'],
    level: 2});
...
ON CREATE SET r.name = "t.edge.KNOWLEDGE PROPERTY GOD"
// 3. Pass 't' forward, find the Parent Topic, and link them
WITH t
MATCH (parent:TOPIC {name: "topic.TRUTH"})
MERGE (parent)-[r2:HAS_THOUGHT]->(t)
ON CREATE SET r2.name = "t.edge.TRUTH->KNOWLEDGE PROPERTY GOD"
RETURN t, parent;
```
