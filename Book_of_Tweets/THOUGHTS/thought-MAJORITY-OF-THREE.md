...
CREATE (t:THOUGHT {    name: "thought.MAJORITY OF THREE",
    alias: "Thought: Majority Of Three",
    parent: "topic.THE GODHEAD",
    tags: ['godhead', 'life', 'death', 'goodness'],
    level: 1});
...
ON CREATE SET r.name = "t.edge.MAJORITY OF THREE"
// 3. Pass 't' forward, find the Parent Topic, and link them
WITH t
MATCH (parent:TOPIC {name: "topic.THE GODHEAD"})
MERGE (parent)-[r2:HAS_THOUGHT]->(t)
ON CREATE SET r2.name = "t.edge.THE GODHEAD->MAJORITY OF THREE"
RETURN t, parent;
```
