...
CREATE (t:THOUGHT {    name: "thought.TEACHER AND IDENTITY",
    alias: "Thought: Teacher And Identity",
    parent: "topic.WISDOM",
    tags: ['wisdom', 'teaching', 'identity', 'growth', 'knowledge'],
    level: 3});
...
ON CREATE SET r.name = "t.edge.TEACHER AND IDENTITY"
// 3. Pass 't' forward, find the Parent Topic, and link them
WITH t
MATCH (parent:TOPIC {name: "topic.WISDOM"})
MERGE (parent)-[r2:HAS_THOUGHT]->(t)
ON CREATE SET r2.name = "t.edge.WISDOM->TEACHER AND IDENTITY"
RETURN t, parent;
```
