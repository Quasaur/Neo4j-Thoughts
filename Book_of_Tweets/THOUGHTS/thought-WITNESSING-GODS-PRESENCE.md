...
CREATE (t:THOUGHT {    name: "thought.WITNESSING GODS PRESENCE",
    alias: "Thought: Witnessing Gods Presence",
    parent: "topic.WORSHIP",
    tags: ['presence', 'healing', 'miracles', 'worship', 'assembly'],
    level: 3});
...
ON CREATE SET r.name = "t.edge.WITNESSING GODS PRESENCE"
// 3. Pass 't' forward, find the Parent Topic, and link them
WITH t
MATCH (parent:TOPIC {name: "topic.WORSHIP"})
MERGE (parent)-[r2:HAS_THOUGHT]->(t)
ON CREATE SET r2.name = "t.edge.WORSHIP->WITNESSING GODS PRESENCE"
RETURN t, parent;
```
