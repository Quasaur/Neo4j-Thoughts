...
CREATE (t:THOUGHT {    name: "thought.GODS SUPERIOR VALUE",
    alias: "Thought: Gods Superior Value",
    parent: "topic.THE GODHEAD",
    tags: ['value', 'reality', 'god', 'majesty', 'divinity'],
    level: 1});
...
ON CREATE SET r.name = "t.edge.GODS SUPERIOR VALUE"
// 3. Pass 't' forward, find the Parent Topic, and link them
WITH t
MATCH (parent:TOPIC {name: "topic.THE GODHEAD"})
MERGE (parent)-[r2:HAS_THOUGHT]->(t)
ON CREATE SET r2.name = "t.edge.THE GODHEAD->GODS SUPERIOR VALUE"
RETURN t, parent;
```
