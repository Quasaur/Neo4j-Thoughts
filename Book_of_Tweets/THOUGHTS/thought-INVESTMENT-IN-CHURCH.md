...
CREATE (t:THOUGHT {    name: "thought.INVESTMENT IN CHURCH",
    alias: "Thought: Investment In Church",
    parent: "topic.RELIGION",
    tags: ['church', 'investment', 'return', 'religion', 'community'],
    level: 4});
...
ON CREATE SET r.name = "t.edge.INVESTMENT IN CHURCH"
// 3. Pass 't' forward, find the Parent Topic, and link them
WITH t
MATCH (parent:TOPIC {name: "topic.RELIGION"})
MERGE (parent)-[r2:HAS_THOUGHT]->(t)
ON CREATE SET r2.name = "t.edge.RELIGION->INVESTMENT IN CHURCH"
RETURN t, parent;
```
