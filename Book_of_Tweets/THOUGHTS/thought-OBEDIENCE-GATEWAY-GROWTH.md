...
CREATE (t:THOUGHT {    name: "thought.OBEDIENCE GATEWAY GROWTH",
    alias: "Thought: Obedience Gateway Growth",
    parent: "topic.SPIRITUALITY",
    tags: ['obedience', 'growth', 'gateway', 'spirituality'],
    level: 2});
...
ON CREATE SET r.name = "t.edge.OBEDIENCE GATEWAY GROWTH"
// 3. Pass 't' forward, find the Parent Topic, and link them
WITH t
MATCH (parent:TOPIC {name: "topic.SPIRITUALITY"})
MERGE (parent)-[r2:HAS_THOUGHT]->(t)
ON CREATE SET r2.name = "t.edge.SPIRITUALITY->OBEDIENCE GATEWAY GROWTH"
RETURN t, parent;
```
