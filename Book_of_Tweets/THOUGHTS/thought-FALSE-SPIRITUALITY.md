...
CREATE (t:THOUGHT {    name: "thought.FALSE SPIRITUALITY",
    alias: "Thought: False Spirituality",
    parent: "topic.SPIRITUALITY",
    tags: ['spirituality', 'deception', 'devil', 'character', 'excuse'],
    level: 2});
...
ON CREATE SET r.name = "t.edge.FALSE SPIRITUALITY"
// 3. Pass 't' forward, find the Parent Topic, and link them
WITH t
MATCH (parent:TOPIC {name: "topic.SPIRITUALITY"})
MERGE (parent)-[r2:HAS_THOUGHT]->(t)
ON CREATE SET r2.name = "t.edge.SPIRITUALITY->FALSE SPIRITUALITY"
RETURN t, parent;
```
