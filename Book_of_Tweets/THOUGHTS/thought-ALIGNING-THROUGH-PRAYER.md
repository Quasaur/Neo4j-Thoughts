...
CREATE (t:THOUGHT {    name: "thought.ALIGNING THROUGH PRAYER",
    alias: "Thought: Aligning Through Prayer",
    parent: "topic.SPIRITUALITY",
    tags: ['prayer', 'alignment', 'will', 'purpose'],
    level: 2});
...
ON CREATE SET r.name = "t.edge.ALIGNING THROUGH PRAYER"
// 3. Pass 't' forward, find the Parent Topic, and link them
WITH t
MATCH (parent:TOPIC {name: "topic.SPIRITUALITY"})
MERGE (parent)-[r2:HAS_THOUGHT]->(t)
ON CREATE SET r2.name = "t.edge.SPIRITUALITY->ALIGNING THROUGH PRAYER"
RETURN t, parent;
```
