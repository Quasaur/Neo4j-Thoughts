...
CREATE (t:THOUGHT {    name: "thought.GOD ACTUALLY EXISTS",
    alias: "Thought: God Actually Exists",
    parent: "topic.THE GODHEAD",
    tags: ['existence', 'god', 'fear', 'truth', 'divinity'],
    level: 1});
...
ON CREATE SET r.name = "t.edge.GOD ACTUALLY EXISTS"
// 3. Pass 't' forward, find the Parent Topic, and link them
WITH t
MATCH (parent:TOPIC {name: "topic.THE GODHEAD"})
MERGE (parent)-[r2:HAS_THOUGHT]->(t)
ON CREATE SET r2.name = "t.edge.THE GODHEAD->GOD ACTUALLY EXISTS"
RETURN t, parent;
```
