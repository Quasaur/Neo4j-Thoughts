...
CREATE (t:THOUGHT {    name: "thought.JUDGING MOTIVES DEEDS",
    alias: "Thought: Judging Motives Deeds",
    parent: "topic.THE GODHEAD",
    tags: ['motives', 'deeds', 'judgment', 'god', 'perspective'],
    level: 1});
...
ON CREATE SET r.name = "t.edge.JUDGING MOTIVES DEEDS"
// 3. Pass 't' forward, find the Parent Topic, and link them
WITH t
MATCH (parent:TOPIC {name: "topic.THE GODHEAD"})
MERGE (parent)-[r2:HAS_THOUGHT]->(t)
ON CREATE SET r2.name = "t.edge.THE GODHEAD->JUDGING MOTIVES DEEDS"
RETURN t, parent;
```
