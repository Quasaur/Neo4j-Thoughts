...
CREATE (t:THOUGHT {    name: "thought.RESPONSIBILITY NO AUTHORITY",
    alias: "Thought: Responsibility No Authority",
    parent: "topic.WISDOM",
    tags: ['responsibility', 'authority', 'logic', 'wisdom', 'analogy'],
    level: 3});
...
ON CREATE SET r.name = "t.edge.RESPONSIBILITY NO AUTHORITY"
// 3. Pass 't' forward, find the Parent Topic, and link them
WITH t
MATCH (parent:TOPIC {name: "topic.WISDOM"})
MERGE (parent)-[r2:HAS_THOUGHT]->(t)
ON CREATE SET r2.name = "t.edge.WISDOM->RESPONSIBILITY NO AUTHORITY"
RETURN t, parent;
```
