...
CREATE (t:THOUGHT {    name: "thought.PRIVATE INTERPRETATION",
    alias: "Thought: Private Interpretation",
    parent: "topic.TRUTH",
    tags: ['bible', 'satan', 'truth', 'deception', 'interpretation'],
    level: 2});
...
ON CREATE SET r.name = "t.edge.PRIVATE INTERPRETATION"
// 3. Pass 't' forward, find the Parent Topic, and link them
WITH t
MATCH (parent:TOPIC {name: "topic.TRUTH"})
MERGE (parent)-[r2:HAS_THOUGHT]->(t)
ON CREATE SET r2.name = "t.edge.TRUTH->PRIVATE INTERPRETATION"
RETURN t, parent;
```
