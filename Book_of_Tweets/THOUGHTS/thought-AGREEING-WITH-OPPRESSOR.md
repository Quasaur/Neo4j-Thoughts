...
CREATE (t:THOUGHT {    name: "thought.AGREEING WITH OPPRESSOR",
    alias: "Thought: Agreeing With Oppressor",
    parent: "topic.MORALITY",
    tags: ['oppression', 'dignity', 'money', 'morality', 'society'],
    level: 3});
...
ON CREATE SET r.name = "t.edge.AGREEING WITH OPPRESSOR"
// 3. Pass 't' forward, find the Parent Topic, and link them
WITH t
MATCH (parent:TOPIC {name: "topic.MORALITY"})
MERGE (parent)-[r2:HAS_THOUGHT]->(t)
ON CREATE SET r2.name = "t.edge.MORALITY->AGREEING WITH OPPRESSOR"
RETURN t, parent;
```
