...
CREATE (t:THOUGHT {    name: "thought.CHRISTIANITY STEPS",
    alias: "Thought: Christianity Steps",
    parent: "topic.RELIGION",
    tags: ['faith', 'steps', 'christianity', 'obedience', 'belief'],
    level: 4});
...
ON CREATE SET r.name = "t.edge.CHRISTIANITY STEPS"
// 3. Pass 't' forward, find the Parent Topic, and link them
WITH t
MATCH (parent:TOPIC {name: "topic.RELIGION"})
MERGE (parent)-[r2:HAS_THOUGHT]->(t)
ON CREATE SET r2.name = "t.edge.RELIGION->CHRISTIANITY STEPS"
RETURN t, parent;
```
