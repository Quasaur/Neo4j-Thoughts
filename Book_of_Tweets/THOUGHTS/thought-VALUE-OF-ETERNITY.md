...
```Cypher
CREATE (t:THOUGHT {    name: "thought.VALUE OF ETERNITY",
    alias: "Thought: Eternal Perspective",
    parent: "topic.SPIRITUALITY",
    tags: ["eternity", "perspective", "time", "wisdom", "life_cycle"],
    level: 2});
...
ON CREATE SET r.name = "t.edge.VALUE OF ETERNITY"
// 3. Pass 't' forward, find the Parent Topic, and link them
WITH t
MATCH (parent:TOPIC {name: "topic.SPIRITUALITY"})
MERGE (parent)-[r2:HAS_THOUGHT]->(t)
ON CREATE SET r2.name = "t.edge.SPIRITUALITY->VALUE OF ETERNITY"
RETURN t, parent;
```
