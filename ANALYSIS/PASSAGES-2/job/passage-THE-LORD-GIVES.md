...
tags: ["sovereignty", "blessing", "job", "the_lord", "trust"]
...
CREATE (c:CONTENT {
    ...
    hi_content: "प्रभु ने दिया, और प्रभु ने ही ले लिया; प्रभु के नाम की रहमत बरसे।",
    zh_title: "jīng wén : shàng dì de quán lì",
    zh_content: "cì yǔ de shì zhǔ , shōu qǔ de yě shì zhǔ ; zhǔ de míng shì yīng dāng chēng sòng de ."
})
