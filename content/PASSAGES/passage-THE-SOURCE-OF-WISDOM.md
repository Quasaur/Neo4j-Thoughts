...
CREATE (c:CONTENT {
	name: "content.THE SOURCE OF WISDOM", 
	 ctype: "PASSAGE",
	 en_title: "Passage: The Source of Wisdom", 
...
And He watches over the way of His godly ones.", 
 es_title: "Pasaje: La fuente de la sabiduría", 
...
Y vela por el camino de sus fieles.", 
 fr_title: "Passage : La source de la sagesse",
...
Et il veille sur la voie de ses fidèles.", 
 hi_title: "परिच्छेद: बुद्धि का स्रोत",
...
और वह अपने पवित्र लोगों के रास्ते की निगरानी करते हैं।",
 zh_title: "jīng wén : Zhìhuì de yuánquán", 
