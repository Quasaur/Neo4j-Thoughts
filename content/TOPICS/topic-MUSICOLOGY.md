...
alias: "Topic: The Study of Music"
...
```Cypher
CREATE (t:TOPIC {    name: "topic.MUSICOLOGY",
    alias: "Topic: The Study of Music",
    parent: "topic.HUMANITY",
    tags: ["musicology", "music", "study", "research", "history", "theory"],
    level: 4});
...
CREATE (d:DESCRIPTION {
    name: "desc.MUSICOLOGY",
    en_title: "Topic: The Study of Music",
    en_content: "The scholarly study of music, encompassing the historical, cultural, theoretical, and scientific aspects of music and its role in human society.",
    es_title: "Tema: El estudio de la música",
    ...
    fr_title: "Sujet : L'étude de la musique",
...
MATCH (t:TOPIC)
MATCH (d:DESCRIPTION)
WHERE t.name = "topic.MUSICOLOGY" AND d.name = "desc.MUSICOLOGY"
