...
CREATE (d:DESCRIPTION {
    name: "desc.BEAUTY",
    en_title: "Topic: Beauty of Body or Character",
    en_content: "The quality or group of qualities in a person or thing that gives pleasure to the senses or the mind; a person (especially a woman) who is beautiful; an excellent or appealing quality.",
    es_title: "Tema: Belleza del cuerpo o del carácter",
    ...
    fr_title: "Sujet : Beauté du corps ou du caractère",
    ...
    hi_title: "विषय: शरीर या चरित्र की सुंदरता",
    ...
    zh_title: "Zhǔtí: Shēntǐ zhīměi háishì xìnggé zhīměi",
...
// LINK DESCRIPTION
MATCH (t:TOPIC {name: "topic.BEAUTY"})
MATCH (d:DESCRIPTION {name: "desc.BEAUTY"})
MERGE (t)-[:HAS_DESCRIPTION {name: "edge.BEAUTY"}]->(d);

// LINK PARENT
MATCH (p:TOPIC)
WHERE p.name = "topic.HEALTH"
MATCH (c:TOPIC)
WHERE c.name = "topic.BEAUTY"
