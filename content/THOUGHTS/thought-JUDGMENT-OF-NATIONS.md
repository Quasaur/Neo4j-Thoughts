...
CREATE (c:CONTENT {
    ...
    en_content: "God will not only judge individuals, but nations (ethnic and political). May God grant repentance to the USA.",
    es_title: "Pensamiento: Juicio de las naciones",
    ...
    fr_title: "Pensée : Jugement des Nations",
    ...
    hi_title: "विचार: राष्ट्रों का निर्णय",
    ...
    zh_title: "sī xiǎng : guó jiā de shěn pàn",
...
MERGE (t)-[:HAS_CONTENT { "name": "t.edge.JUDGMENT OF NATIONS" }]->(c);

MATCH (parent:TOPIC {name: "topic.APOCALYPSE"})
MATCH (child:THOUGHT {name: "thought.JUDGMENT OF NATIONS"})
MERGE (parent)-[:HAS_THOUGHT { "name": "t.edge.APOCALYPSE->JUDGMENT OF NATIONS" }]->(child);
```
