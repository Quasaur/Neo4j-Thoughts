...
Rule 10c: Following is an example of how the new entry should look:
```cypher
ctype: "THOUGHT",
```
...
Rule 16a: The value of the "name" property of the relationship has two parts:
- the prefix "edge."
...
Rule 16b: Following is an example of the part of the fourth cypher query that contains the "name" property:
```cypher
...
Rule 17a: The value of the "name" property of the relationship has two parts:
- the prefix "t.edge."
...
Rule 18a: The value of the "name" property of the relationship has two parts:
- the prefix "q.edge."
